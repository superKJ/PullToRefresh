package com.xgn.vly.client.commonui.circleindicator;
...
public class CircleIndicator extends LinearLayout {
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        if (mViewpager != null && mViewpager.getAdapter() != null) {
            ...
            mViewpager.getAdapter().registerDataSetObserver(getDataSetObserver());
        }
    }

    public void setAnimatorIn(boolean isAnima){
