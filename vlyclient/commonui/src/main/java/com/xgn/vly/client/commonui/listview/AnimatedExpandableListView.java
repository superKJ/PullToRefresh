package com.xgn.vly.client.commonui.listview;
...
public class AnimatedExpandableListView extends ExpandableListView {
    ...
    private static class EndExpandAnimation extends Animation {
        private int baseHeight;
        private int delta;
        private View view;
        private GroupInfo groupInfo;

        private EndExpandAnimation(View v, int endHeight, int startHeight, GroupInfo info) {
